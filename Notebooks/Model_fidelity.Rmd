...
plot_hist <- function(bootstrapped_array_WC,fun,main) {
  bootstrapped_fun=apply(bootstrapped_array_WC,MARGIN = 2,FUN = fun)
  ggplot()+
    geom_histogram(aes(x=bootstrapped_fun),color='black',fill='orange')+
...
p1=plot_hist(bootstrapped_array_WC,mean,'Mean')
p2=plot_hist(bootstrapped_array_WC,sd,'Standard Deviation')
p3=plot_hist(bootstrapped_array_WC,skewness,'Skewness')
p4=plot_hist(bootstrapped_array_WC,kurtosis,'Kurtosis')

p1_cor=plot_hist(bootstrapped_array_WC_biascor,mean,'Mean')
p2_cor=plot_hist(bootstrapped_array_WC_biascor,sd,'Standard Deviation')
p3_cor=plot_hist(bootstrapped_array_WC_biascor,skewness,'Skewness')
p4_cor=plot_hist(bootstrapped_array_WC_biascor,kurtosis,'Kurtosis')
