...
# We should be in the UNSEEN-trends/Notebooks directory.
...
plot_hist_combined <- function(bootstrapped_array_WC,bootstrapped_array_WC_biascor,fun,main,units,fontsize) {
  bootstrapped_fun=apply(bootstrapped_array_WC,MARGIN = 2,FUN = fun)
...
p1_comb=plot_hist_combined(bootstrapped_array_WC,bootstrapped_array_WC_biascor,fun=mean,main = 'Mean',units = 'mm',fontsize=14)
p2_comb=plot_hist_combined(bootstrapped_array_WC,bootstrapped_array_WC_biascor,fun=sd,main = 'Standard Deviation',units = 'mm',fontsize=14)
p3_comb=plot_hist_combined(bootstrapped_array_WC,bootstrapped_array_WC_biascor,fun=skewness,main = 'Skewness',units = '-',fontsize=14)
p4_comb=plot_hist_combined(bootstrapped_array_WC,bootstrapped_array_WC_biascor,fun=kurtosis,main = 'Kurtosis',units = '-',fontsize=14)

ggarrange(p1_comb,p2_comb,p3_comb,p4_comb,
          labels = c("a", "b","c","d"),
          font.label = list(size = 14, color = "black", face ="bold", family = NULL),
          ncol = 2, nrow = 2)%>%
    ggsave(filename = "../graphs/Fidelity_UNSEEN_combined.png",width =180,height = 180, units='mm',dpi=300)
...
ggsave(p1,filename = "../graphs/Fidelity_EVT.png",width =88,height = 100, units='mm',dpi=300)
p1
...
ggarrange(p2, p1,p3,
          ...
          ncol = 1, nrow = 3,
          common.legend = TRUE) #%>%
# ggsave(filename = "../graphs/Fidelity_sensitivity.png",width =180,height = 210,units = 'mm' )
