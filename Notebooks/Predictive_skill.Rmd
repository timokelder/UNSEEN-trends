...
Var_signal_obs=sd(obs)^2 #The signal is the interannual variance of the model mean

# sd_ensemble=apply(Extremes_WC,MARGIN = c(1,2),FUN=sd) #The standard deviation for each ensemble member and lead time
sd_ensemble=apply(Extremes_WC,MARGIN = c(3),FUN=sd) #The standard deviation for each ensemble member and lead time
Var_noise=mean(sd_ensemble)^2 #The noise is the variance of the individual ensemble members about the ensemble mean
Var_noise_obs=sd(obs)^2 #The noise is the variance of the individual ensemble members about the ensemble mean
