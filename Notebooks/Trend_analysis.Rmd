...
Obs_GEV_MLE=fit_obs <- fevd(x = obs)
Obs_GEV_Bayes=fit_obs <- fevd(x = obs,method = "Bayesian")
Obs_GEV_Bayes=fit_obs <- fevd(x = obs,method = "Lmoments")
Obs_Gumbel=fit_obs <- fevd(x = obs,type = 'Gumbel')
...
AB=Plot_non_stationary(GEV_type = 'GEV')
...
# ABCD=
  ggarrange(AB, CD,
            ...
            common.legend = T,
            ncol = 1, nrow = 2) %>% 
    ggsave(filename = "../graphs/Trends.png")
